            ...
            <div class="col-lg-10">
                <div class="row">
                    ...
                    if (isset($_GET['cat_id'])) {
                        ...
                        $query = "SELECT * FROM products WHERE product_cat_id = $caught_cat_id";
                        $show_cat = mysqli_query($conn, $query);
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4" style="margin-top:100px;">
                        ...
                        <div class="card" style="width: 18rem;height:auto;">
                            <img class="card-img-top img-fluid resizing" src="resources/img/<?php echo $product_image?>" alt="Card image cap" style="  height: 250px;">
                                    ...
                                    <div class="modal-dialog " role="document">
                                        <div class="modal-content" >
                                            ...
                                            <div class="modal-body">
                                                <img src="resources/img/<?php echo $product_image?>" alt="" class="img-fluid " style="  height: 250px; width:100%;">
